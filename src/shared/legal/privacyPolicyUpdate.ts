  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "이용자가 지난 공간 기록의 인터넷 공개를 직접 선택한 경우, 회사는 공개 링크 제공, 공개 전 안전 확인, 신고·차단과 운영정책 집행을 위해 기록과 공개 상태를 처리합니다.",
      ],
    },
    {
      ...items,
      paragraphs: [
        ...
        "기록 인터넷 공개 이용 시: 공개 식별값과 시각, 공개·검토·숨김 상태, 공개 안내 동의 버전과 시각, 자동 안전 확인 사유, 관리자 검토·제재 이력, 신고 사유와 내용, 작성자 차단 관계. 공개 페이지에는 이름·이메일·계정 식별값과 사진 원본 위치정보를 표시하지 않습니다.",
      ],
    },
    {
      ...retention,
      paragraphs: [
        ...
        "기록 공개를 중지하면 공개 식별값과 공개 시각을 삭제하여 기존 링크와 이미지 접근을 차단합니다. 공개 동의와 상태 변경·신고·관리자 조치 기록은 분쟁 대응과 운영정책 이행 확인에 필요한 기간 동안 보관하며, 기록 또는 계정 삭제 시 법령상 별도 보존이 필요한 자료를 제외하고 원본 기록·이미지와의 연결을 삭제합니다.",
      ],
    },
    provision,
    {
    ...
    destruction,
    {
      ...
      paragraphs: [
        ...
        "지난 공간 기록은 기본적으로 비공개이며, 이용자가 기록별로 인터넷 공개를 선택하거나 중지할 수 있습니다. 공개 중지 시 기존 주소는 다시 사용할 수 없고, 공개 거절·숨김·제한 조치에는 1:1 문의 또는 admin@tuti.today로 이의를 제기할 수 있습니다.",
      ],
    },
    {
      ...safeguards,
      paragraphs: [
        ...
        "공개 요청 기록은 연락처·외부 링크·위험 표현·반복 홍보 패턴을 자동 확인하고, 이미지 또는 판단하기 어려운 내용은 관리자 확인 전 공개를 보류합니다. 공개 상태 변경과 신고·차단·관리자 조치는 감사 기록으로 남깁니다.",
      ],
    },
    officer,
    changes,
